SHELL := bash
NAME := ocis-canary
IMPORT := github.com/cernbox/$(NAME)
BIN := bin
DIST := dist
HUGO := hugo
...
$(GOPATH)/bin/protoc-gen-swagger:
	go get -v github.com/grpc-ecosystem/grpc-gateway/protoc-gen-swagger@v1.16.0

pkg/proto/v0/canary.pb.go: pkg/proto/v0/canary.proto
	protoc \
		-I=third_party/ \
		-I=pkg/proto/v0/ \
		--go_out=pkg/proto/v0 canary.proto

pkg/proto/v0/canary.pb.micro.go: pkg/proto/v0/canary.proto
	protoc \
		-I=third_party/ \
		-I=pkg/proto/v0/ \
		--micro_out=pkg/proto/v0 canary.proto

pkg/proto/v0/canary.pb.web.go: pkg/proto/v0/canary.proto
	protoc \
		-I=third_party/ \
		-I=pkg/proto/v0/ \
		--microweb_out=pkg/proto/v0 canary.proto

pkg/proto/v0/canary.swagger.json: pkg/proto/v0/canary.proto
	protoc \
		-I=third_party/ \
		-I=pkg/proto/v0/ \
		--swagger_out=logtostderr=true:pkg/proto/v0 canary.proto

.PHONY: protobuf
protobuf:  $(GOPATH)/bin/protoc-gen-go $(GOPATH)/bin/protoc-gen-micro $(GOPATH)/bin/protoc-gen-microweb $(GOPATH)/bin/protoc-gen-swagger pkg/proto/v0/canary.pb.go pkg/proto/v0/canary.pb.micro.go pkg/proto/v0/canary.pb.web.go pkg/proto/v0/canary.swagger.json
